                ...
                if (pos == vItem.length) {
                    ...
                    while (resul != null) {
                        entrada = JOptionPane.showInputDialog(null,
                                "Já existe um item com esse histórico, digite um diferente:", "Erro",
                    ...
                    item.setPos(pos);
                    JOptionPane.showMessageDialog(null, "Item registrado com sucesso!", "Item Cadastrado",
                    JOptionPane.INFORMATION_MESSAGE);
                }
                break;
            case 2:
                if (item.getVetorItem() == null) {
                    JOptionPane.showMessageDialog(null, "Não existe itens registrados!", "Erro",
                            JOptionPane.ERROR_MESSAGE);
                } else {
                    entrada = JOptionPane.showInputDialog(null, "Digite o histórico do item:", "Histórico",
                            JOptionPane.INFORMATION_MESSAGE);
